...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.KeySystem then
		if game.Players.LocalPlayer.Name == "ProAIt5000" then
			Passthrough = true
		elseif game.Players.LocalPlayer.Name == "1kS_up" then
			Passthrough = true
		elseif game.Players.LocalPlayer.Name == "aubrey2131456" then
			Passthrough = true
		elseif game.Players.LocalPlayer.Name == "Jojo_gamer1001" then
			Passthrough = true
		elseif game.Players.LocalPlayer.Name == "KvllYourselt" then
			Passthrough = true
		elseif game.Players.LocalPlayer.Name == "dittsfuneral" then
			Passthrough = true
		elseif game.Players.LocalPlayer.Name == "zx_Jaxson" then
			Passthrough = true
		elseif game.Players.LocalPlayer.Name == "shoestringinmahur" then
			Passthrough = true
		elseif not Settings.KeySettings then
			Passthrough = true
			return
		end
